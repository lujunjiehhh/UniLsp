...
internal class PyDebuggerEvaluator(private val myProject: Project, private val myDebugProcess: PyFrameAccessor) :
    XDebuggerEvaluator(), XDebuggerDocumentOffsetEvaluator {
