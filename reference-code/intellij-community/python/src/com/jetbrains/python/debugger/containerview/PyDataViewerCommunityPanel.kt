...
class PyDataViewerCommunityPanel(
    ...
    private fun createAndSetupTopToolbar(): JPanel {
        ...
        val rightActionToolbar = actionManager.createActionToolbar("PyDataView", rightActionGroup, true).apply {
            layoutStrategy =
                ToolbarLayoutStrategy.NOWRAP_STRATEGY // For removing the empty space on the right of the toolbar.
            targetComponent = panelWithTable
        }
    ...
    private fun createEditorField(commandSource: DataViewerCommandSource): EditorTextField {
        return object : EditorTextField(
            EditorFactory.getInstance().createDocument(""),
            dataViewerModel.project,
    ...
    companion object {
        val PY_DATA_VIEWER_COMMUNITY_PANEL_KEY: DataKey<AbstractDataViewTable> =
            DataKey.create<AbstractDataViewTable>("PY_DATA_VIEWER_COMMUNITY_PANEL_KEY")
    }
}