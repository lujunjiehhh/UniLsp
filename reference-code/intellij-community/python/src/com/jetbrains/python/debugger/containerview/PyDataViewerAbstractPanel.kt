...
abstract class PyDataViewerAbstractPanel(
    ...
    fun apply(debugValue: PyDebugValue, modifier: Boolean, commandSource: DataViewerCommandSource? = null) {
        ...
        if (!modifier) {
            ...
            PyDataViewerCollector.logDataOpened(
                dataViewerModel.project, debugValue.type,
                dimensionsSize,
    ...
    protected fun updateTabNameSlicingFieldAndFormatField(
        chunk: ArrayChunk?,
        originalDebugValue: PyDebugValue,
        modifier: Boolean
    ) {
        ...
        val realName =
            if (debugValue == null || debugValue.name == originalDebugValue.tempName) originalDebugValue.name else chunk.slicePresentation
