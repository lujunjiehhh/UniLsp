...
interface ClassNameCalculator {
    ...
    companion object : ClassNameCalculator {
        ...
        internal val EP_NAME =
            ExtensionPointName<ClassNameCalculator>("org.jetbrains.kotlin.idea.debugger.base.util.classNameCalculator")
...
private class CompositeClassNameCalculator(
    ...
    override fun getClassName(element: KtElement): String? {
        ...
        return instances.reversed()
            .firstNotNullOfOrNull { classNameCalculator -> classNameCalculator.getClassName(element) }
    }
...
private object DefaultClassNameCalculator : ClassNameCalculator {
    ...
    override fun getTopLevelNames(file: KtFile): List<String> {
        return CachedValuesManager.getCachedValue(file) {
            ...
            val classNames =
                declarations.filterIsInstance<KtClassLikeDeclaration>().mapNotNull { it.getClassId()?.asString() }
...
private fun getFileFQN(file: KtFile): String =
    JvmFileClassUtil.getFileClassInfoNoResolve(file).fileClassFqName.asString()
