...
interface CoroutineDebuggerColors {
    companion object {
        ...
        val VALUE_ATTRIBUTES =
            TextAttributesKey.createTextAttributesKey("KOTLIN_COROUTINE_DEBUGGER_VALUE", HighlighterColors.TEXT)
    }
}
...
internal class SimpleColoredTextIconPresentationRenderer {
    ...
    fun renderThreadGroup(groupName: String, isCurrent: Boolean) =
        SimpleColoredTextIcon(
            if (isCurrent) AllIcons.Debugger.ThreadGroupCurrent else AllIcons.Debugger.ThreadGroup,
            true,
            groupName
        )
