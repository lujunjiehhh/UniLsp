...
sealed class MethodEvaluator<T>(val method: Method?) {
    ...
    class MirrorMethodEvaluator<T, F>(method: Method?, private val mirrorProvider: MirrorProvider<T, F>) :
        MethodEvaluator<T>(method) {
