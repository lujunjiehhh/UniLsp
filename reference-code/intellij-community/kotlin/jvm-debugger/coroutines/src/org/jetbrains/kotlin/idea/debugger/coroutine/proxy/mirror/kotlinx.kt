...
class CoroutineContext(context: DefaultExecutionContext) :
    ...
    private fun <T> getElementValue(
        value: ObjectReference,
        context: DefaultExecutionContext,
        keyProvider: ContextKey<T>
    ): T? {
...
abstract class ContextKey<T>(name: String, context: DefaultExecutionContext) :
    BaseMirror<ObjectReference, T>(name, context) {
    abstract fun key(): ObjectReference?
}

class CoroutineName(context: DefaultExecutionContext) :
    ContextKey<String>("kotlinx.coroutines.CoroutineName", context) {
...
class CoroutineDispatcher(context: DefaultExecutionContext) :
    ContextKey<String>("kotlinx.coroutines.CoroutineDispatcher", context) {
    private val key by FieldDelegate<ObjectReference>("Key")
