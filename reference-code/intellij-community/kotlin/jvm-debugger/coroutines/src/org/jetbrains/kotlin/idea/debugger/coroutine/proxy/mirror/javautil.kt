...
class JavaLangObjectToString(context: DefaultExecutionContext) :
    BaseMirror<ObjectReference, String>("java.lang.Object", context) {
...
class JavaUtilAbstractCollection(context: DefaultExecutionContext) :
    ...
    ): MirrorOfJavaLangAbstractCollection {
