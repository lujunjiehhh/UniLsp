...
class CoroutineDumpPanel(
    ...
    init {
        ...
        val leftPanel = JPanel(BorderLayout()).apply {
            ...
            add(
                ScrollPaneFactory.createScrollPane(coroutinesList, SideBorder.LEFT or SideBorder.RIGHT),
                BorderLayout.CENTER
            )
        }
    ...
    private fun getAttributes(infoData: CoroutineInfoData): SimpleTextAttributes {
        return when {
            ...
            infoData.continuationStackFrames.isEmpty() -> SimpleTextAttributes(
    ...
    private class CopyToClipboardAction(
        private val myCoroutinesDump: List<CoroutineInfoData>,
