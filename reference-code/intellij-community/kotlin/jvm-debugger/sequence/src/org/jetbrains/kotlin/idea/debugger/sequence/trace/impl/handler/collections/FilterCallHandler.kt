...
class FilterCallHandler : BothSemanticsHandler {
    ...
    override fun getResultExpression(call: StreamCall, dsl: Dsl, variables: List<Variable>): Expression {
        return dsl.newArray(
            dsl.types.ANY,
            TextExpression(VALUES_ARRAY_NAME),
            TextExpression(PREDICATE_RESULT_ARRAY_NAME)
        )
    }

    override fun transformAsIntermediateCall(
    ...
    override fun transformAsTerminalCall(
