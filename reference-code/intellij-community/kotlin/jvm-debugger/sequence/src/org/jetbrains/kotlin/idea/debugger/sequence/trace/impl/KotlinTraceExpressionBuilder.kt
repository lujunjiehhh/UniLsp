...
class KotlinTraceExpressionBuilder(dsl: Dsl, handlerFactory: HandlerFactory) :
    ...
    override fun createTraceExpression(chain: StreamChain): String {
        ...
        val resultDeclaration =
            dsl.declaration(dsl.variable(dsl.types.nullable { ANY }, resultVariableName), dsl.nullExpression, true)
