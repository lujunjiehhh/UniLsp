...
class OrdinaryClassLoadingAdapter : ClassLoadingAdapter {
    private companion object {
        ...
        private fun generateLambdaToString(classVisitor: ClassVisitor) {
            ...
            val methodVisitor =
                classVisitor.visitMethod(Opcodes.ACC_PUBLIC, "toString", "()Ljava/lang/String;", null, null)
    ...
    override fun isApplicable(
        ...
        info: ClassLoadingAdapter.Companion.ClassInfoForEvaluator
    ): Boolean {
    ...
    override fun loadClasses(context: ExecutionContext, classes: Collection<ClassToLoad>): ClassLoaderReference {
        ...
        val classLoader = try {
            ...
            throw EvaluateException(
                KotlinDebuggerEvaluationBundle.message("error.creating.class.loader", e.toString()),
                e
            )
        }
    ...
    private fun defineClass(
        ...
        try {
            ...
            val defineMethod =
                classLoaderType.concreteMethodByName("defineClass", "(Ljava/lang/String;[BII)Ljava/lang/Class;")
