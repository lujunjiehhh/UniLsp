...
private class ReflectionCallMethodVisitor(
    ...
    private fun unboxValue(type: Type, boxedType: Type) {
        ...
        val methodName =
            EvaluatorValueConverter.UNBOXING_METHOD_NAMES[boxedClassName] ?: error("Unexpected boxed type: $boxedType")
    ...
    private fun findClass(internalName: String): PsiClass? {
        ...
        val classType =
            SignatureParsing.parseTypeStringToTypeInfo(iterator, StubBuildingVisitor.GUESSING_PROVIDER).text()
    ...
    override fun visitFieldInsn(opcode: Int, owner: String, name: String, descriptor: String) {
        ...
        val methodSignature =
            if (isPut) "(Ljava/lang/Object;Ljava/lang/Object;)V" else "(Ljava/lang/Object;)Ljava/lang/Object;"
    ...
    private fun findMethod(owner: String, name: String, descriptor: String): PsiMethod? {
        ...
        val methods =
            if (name == "<init>") declaringClass.constructors else declaringClass.findMethodsByName(name, true)
    ...
    private fun resolveApplicableMethodCall(
        opcode: Int,
        owner: String,
        name: String,
        descriptor: String
        ...
        val declaringClassTypeDescriptor =
            ClassUtil.getBinaryPresentation(declaringClassType).takeIf { it.isNotEmpty() } ?: return null
        ...
        for (index in 0 until parameterCount) {
            ...
            val parameterTypeDescriptor =
                ClassUtil.getBinaryPresentation(parameter.type).takeIf { it.isNotEmpty() } ?: return null
            ...
            for (index in 0 until resolvedCall.parameterTypes.size) {
                ...
                if (parameterType != boxedParameterType) {
                    super.visitFieldInsn(
                        Opcodes.GETSTATIC,
                        boxedParameterType.internalName,
                        "TYPE",
                        "Ljava/lang/Class;"
                    )
                } else {
    ...
    override fun visitMethodInsn(opcode: Int, owner: String, name: String, descriptor: String, isInterface: Boolean) {
        ...
        val returnType =
            if (isConstructor) resolvedCall.declaringClassType else Type.getMethodType(descriptor).returnType
