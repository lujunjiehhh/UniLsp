...
abstract class KotlinCodeFragmentFactoryBase : JavaDebuggerCodeFragmentFactory() {
    ...
    override fun createPresentationPsiCodeFragmentImpl(
        ...
        val convertedFragment = try {
            ...
            val convertedExpression = ActionUtil.underModalProgress(
                project,
                KotlinDebuggerEvaluationBundle.message("progress.title.converting.java.expression.to.kotlin")
            ) {
