...
class KotlinK2CodeFragmentFactory : KotlinCodeFragmentFactoryBase() {
    ...
    override fun createPsiCodeFragmentImpl(
        ...
        val codeFragment =
            KtBlockCodeFragment(project, "fragment.kt", item.text, initImports(item.imports), contextElement).apply {
                /*
                ...
                if (contextElement != null) {
                    ...
                    virtualFile.analysisContextModule =
                        jvmLeafModule?.toKaSourceModuleWithElementSourceModuleKindOrProduction(contextElement)
                }
            }
