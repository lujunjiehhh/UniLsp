...
class KotlinK1CodeFragmentFactory : KotlinCodeFragmentFactoryBase() {
    override fun createPsiCodeFragmentImpl(
        ...
        val codeFragment =
            KtBlockCodeFragment(project, "fragment.kt", item.text, initImports(item.imports), contextElement)
    ...
    private fun isJavaContextAccepted(): Boolean =
        Registry.`is`("debugger.enable.kotlin.evaluator.in.java.context", false)
