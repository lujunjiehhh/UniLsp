...
internal class IRFragmentCompilerCodegen {
    fun codegenFactory(
        ...
        val mangler =
            JvmDescriptorMangler(MainFunctionDetector(bindingContext, compilerConfiguration.languageVersionSettings))
    ...
    fun extractResult(
        ...
        val newCaptures: List<SmartCodeFragmentParameter> =
            generationState.newFragmentCaptureParameters.map { (name, type, target) ->
                val kind = when {
