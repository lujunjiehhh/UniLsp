...
class DebuggerFieldSyntheticScope(private val javaSyntheticPropertiesScope: JavaSyntheticPropertiesScope) :
    ...
    private fun collectJavaProperties(
        ...
        for (field in clazz.jClass.fields) {
            ...
            val type = typeResolver.transformJavaType(field.type, TypeUsage.COMMON.toAttributes())
