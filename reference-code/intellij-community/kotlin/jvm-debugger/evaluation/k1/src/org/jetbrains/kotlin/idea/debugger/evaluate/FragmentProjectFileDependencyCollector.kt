    ...
    fragment.accept(object : KtTreeVisitorVoid() {
        override fun visitExpression(expression: KtExpression) {
            ...
            if (descriptor.visibility == DescriptorVisibilities.LOCAL && !descriptor.isValueDescriptorWithNonLocalType()) {
                ...
                val declaration =
                    DescriptorToSourceUtils.getSourceFromDescriptor(thisReceiver.classDescriptor) ?: return
                ...
                val declaration =
                    DescriptorToSourceUtils.getSourceFromDescriptor((descriptor).constructedClass) ?: return
                files.add(declaration.containingFile as? KtFile ?: return)
            }
        }
        ...
        private fun CallableDescriptor.isValueDescriptorWithNonLocalType(): Boolean {
            val declarationDescriptor =
                (this as? ValueDescriptor)?.type?.constructor?.declarationDescriptor as? ClassDescriptor ?: return false
