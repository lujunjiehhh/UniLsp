...
private object DebugForeignPropertyModuleDescriptor :
    ...
    override fun getPackage(fqName: FqName): PackageViewDescriptor {
        return object : PackageViewDescriptor,
            DeclarationDescriptorImpl(Annotations.EMPTY, FqName.ROOT.shortNameOrSpecial()) {
