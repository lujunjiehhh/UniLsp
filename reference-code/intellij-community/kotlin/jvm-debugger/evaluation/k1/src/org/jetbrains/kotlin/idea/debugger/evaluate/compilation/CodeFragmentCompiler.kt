...
class CodeFragmentCompiler(private val executionContext: ExecutionContext) {
    fun compile(
        ...
        compilingStrategy: CodeFragmentCompilingStrategy,
    ...
    private fun doCompile(
        ...
        val moduleDescriptorWrapper =
            EvaluatorModuleDescriptor(codeFragment, moduleDescriptor, filesToCompile, resolveSession)
        ...
        val parameterInfo =
            fragmentCompilerBackend.computeFragmentParameters(executionContext, codeFragment, bindingContext)
    ...
    private class GeneratedClassFilterForCodeFragment(private val codeFragment: KtCodeFragment) :
    ...
    private fun createDescriptorsForCodeFragment(
        ...
        val constructor =
            ClassConstructorDescriptorImpl.create(classDescriptor, Annotations.EMPTY, true, classDescriptor.source)
...
private class EvaluatorMemberScopeForMethod(private val methodDescriptor: SimpleFunctionDescriptor) :
    MemberScopeImpl() {
