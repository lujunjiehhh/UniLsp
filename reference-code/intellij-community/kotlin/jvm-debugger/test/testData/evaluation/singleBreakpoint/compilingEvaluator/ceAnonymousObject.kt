...
public val publicTopLevelObject: Any = object {
    fun test() = 1
}
private val privateTopLevelObject = object {
    fun test() = 1
}
...
class MyClass {
    public val publicObject: Any = object {
        fun test() = 1
    }
    protected val protectedObject: Any = object {
        fun test() = 1
    }
    private val privateObject = object {
        fun test() = 1
    }
