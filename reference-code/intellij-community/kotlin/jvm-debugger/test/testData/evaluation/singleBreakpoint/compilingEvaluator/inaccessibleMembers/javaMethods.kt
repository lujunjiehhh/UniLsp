...
public class JavaMethods {
    private static double s1(int a, Long b, String c)
    { return -1.0; }
    static String s2()
    { return "foo"; }
    private static int s3(char c, String s, boolean b)
    { return 2; }

    private long i1(int a, Long b, String c)
    { return -2; }
    String i2()
    { return "bar"; }
    private int i3(char c, String s, boolean b)
    { return 4; }
}
