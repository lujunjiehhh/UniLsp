...
public class FieldsGetters {
    ...
    public static
    class PrivateFieldPublicGetter {
    ...
    public static
    class PrivateFieldPrivateGetter {
    ...
    public static
    class PublicGetter1 extends PublicField
    {
        public String getFoo() {
            return "g";
        }
    ...
    public static
    class PublicGetter2 extends PackagePrivateField
    {
        public String getFoo() {
            return "h";
        }
    ...
    public static
    class PrivateGetter1 extends PrivateField
    {
    ...
    public static
    class PublicFieldAndGetterInParent extends PublicGetterOnly
    {
        public String foo = "b";
    }
