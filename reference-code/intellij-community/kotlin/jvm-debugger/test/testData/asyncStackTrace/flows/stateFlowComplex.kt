...
suspend fun <T> `~~~!!! recognizableFrameWithEmitInAsyncStackTraceAssign 1 !!!~~~`(
...
suspend fun <T> `~~~!!! recognizableFrameWithEmitInAsyncStackTraceCas 1 !!!~~~`(
    flow: MutableStateFlow<T>,
    old: T,
    new: T
) {
...
suspend fun <T> `~~~!!! recognizableFrameWithEmitInAsyncStackTraceAssign 2 !!!~~~`(
    flow: MutableStateFlow<T>,
    value: T
) {
    flow.value = value
...
suspend fun <T> `~~~!!! recognizableFrameWithEmitInAsyncStackTraceCas 2 !!!~~~`(
    flow: MutableStateFlow<T>,
    old: T,
    new: T
) {
...
suspend fun <T> `~~~!!! recognizableFrameWithEmitInAsyncStackTraceAssign 3 !!!~~~`(
    flow: MutableStateFlow<T>,
    value: T
) {
    flow.value = value
...
suspend fun <T> `~~~!!! recognizableFrameWithEmitInAsyncStackTraceCas 3 !!!~~~`(
    flow: MutableStateFlow<T>,
    old: T,
    new: T
) {
...
suspend fun <T> `~~~!!! recognizableFrameWithEmitInAsyncStackTraceAssign 4 !!!~~~`(
    flow: MutableStateFlow<T>,
    value: T
) {
    flow.value = value
...
suspend fun <T> `~~~!!! recognizableFrameWithEmitInAsyncStackTraceCas 4 !!!~~~`(
    flow: MutableStateFlow<T>,
    old: T,
    new: T
) {
