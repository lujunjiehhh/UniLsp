...
abstract class AbstractKotlinExceptionFilterTest : KotlinLightCodeInsightFixtureTestCase() {
    ...
    protected fun doTest(unused: String) {
        ...
        var result =
            filter.applyFilter(text, text.length) ?: throw AssertionError("Couldn't apply filter to $stackTraceElement")
        ...
        if (InTextDirectivesUtils.isDirectiveDefined(fileText, "SMAP_APPLIED")) {
            ...
            result = filter.applyFilter(newText, newText.length)
        ...
        val expectedLineNumber =
            InTextDirectivesUtils.getPrefixedInt(fileText, "// LINE: ") ?: error("Line directive not found")
