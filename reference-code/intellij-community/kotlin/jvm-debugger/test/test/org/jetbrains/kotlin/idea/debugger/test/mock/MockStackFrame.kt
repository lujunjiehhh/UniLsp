...
class MockStackFrame(private val location: Location) : StackFrame {
    ...
    override fun thread(): ThreadReference {
    ...
    override fun getValue(variable: LocalVariable?): Value {
        TODO("Not yet implemented")
    }

    override fun getValues(variables: List<LocalVariable>?): MutableMap<LocalVariable, Value> {
        TODO("Not yet implemented")
    }
