...
internal class FramePrinter(private val suspendContext: SuspendContextImpl) {
    ...
    private fun computeInfo(container: XValueContainer): ValueInfo {
        ...
        when (container) {
            ...
            is XStackFrame -> {
                val sourcePosition =
                    DebuggerUtilsEx.toSourcePosition(container.sourcePosition, suspendContext.debugProcess.project)
    ...
    private fun computeValue(descriptor: NodeDescriptorImpl?): String? {
        ...
        suspendContext.managerThread.schedule(object : SuspendContextCommandImpl(suspendContext) {
            override fun contextAction(suspendContext: SuspendContextImpl) {
                ...
                val immediateValue =
                    renderer.calcLabel(descriptor, evaluationContext) { updateResult(descriptor.valueText) }
