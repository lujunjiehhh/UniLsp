...
private object KotlinVariablesModeSettingsMutator :
    SettingsMutator<Boolean>(DebuggerPreferenceKeys.SHOW_KOTLIN_VARIABLES) {
...
private object ShowLibraryStackFramesMutator :
    SettingsMutator<Boolean>(DebuggerPreferenceKeys.SHOW_LIBRARY_STACK_FRAMES) {
    override fun setValue(value: Boolean, project: Project): Boolean {
...
private object UseXSessionPauseListenerMutator :
    SettingsMutator<Boolean>(DebuggerPreferenceKeys.USE_XSESSION_PAUSE_LISTENER) {
    override fun setValue(value: Boolean, project: Project): Boolean {
