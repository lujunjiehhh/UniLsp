...
class TypedCollectionChainTest : TypedChainTestCase("collection/positive/types") {
    ...
    fun testFewTransitions1() =
        doTest(
            KotlinSequenceTypes.BYTE,
            KotlinSequenceTypes.ANY,
            KotlinSequenceTypes.NULLABLE_ANY,
            KotlinSequenceTypes.INT
        )

    fun testFewTransitions2() =
        doTest(
            KotlinSequenceTypes.CHAR,
            KotlinSequenceTypes.BOOLEAN,
            KotlinSequenceTypes.DOUBLE,
            KotlinSequenceTypes.ANY
        )
}