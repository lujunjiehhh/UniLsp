...
class K2DfaAssistTest : DfaAssistTest(), ExpectedPluginModeProvider {
        ...
        doTest(
            ...
            frame.addVariable(
                MockLocalVariable(
                    vm,
                    "x",
                    vm.createReferenceType(String::class.java),
                    null
                )
            )
        }
    ...
    fun testInlineFunction() {
        ...
        doTest(text) { vm, frame ->
            frame.addVariable(
                "x${KotlinDebuggerConstants.INLINE_FUN_VAR_SUFFIX}",
        ...
        doTest(text) { vm, frame ->
            frame.addVariable(
                MockLocalVariable(
                    vm,
                    "nullable",
                    vm.createReferenceType(java.lang.Boolean::class.java),
                    null
                )
            )
        }
    ...
    fun testLambdaInsideInlineFunction() {
        ...
        doTest(text) { vm, frame ->
            frame.addVariable(
                "\$this\$useClazz_u24lambda_u240\$iv",
                MockValue.createValue("foo", String::class.java, vm)
            )
        }
    }
