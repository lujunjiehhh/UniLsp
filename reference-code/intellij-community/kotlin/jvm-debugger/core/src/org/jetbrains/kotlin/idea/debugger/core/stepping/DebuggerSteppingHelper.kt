...
object DebuggerSteppingHelper {
    ...
    fun createStepOverCommandForSuspendSwitch(
        suspendContext: SuspendContextImpl,
            ...
            object : DebugProcessImpl.ResumeCommand(suspendContext) {
                override fun contextAction(suspendContext: SuspendContextImpl) {
                    try {
                        ...
                        suspendContext.debugProcess.createStepIntoCommand(
                            suspendContext,
                            ignoreBreakpoints,
                            methodFilter
                        ).contextAction(
    ...
    fun createRunToCursorCommand(
        ...
        return with(debugProcess) {
            object : DebugProcessImpl.RunToCursorCommand(suspendContext, position, ignoreBreakpoints) {
                val myThreadFilter =
                    lazy { extractJobInfo(suspendContext) ?: super.getThreadFilterFromContext(suspendContext) }
