    ...
    private suspend fun visitTraceElement(
        ...
        when (element) {
            is BytecodeTraceElement.InlineCall -> {
                val calledInlineFunction =
                    getCalledInlineFunction(positionManager, element.callInfo.startLocation) ?: return
...
private sealed class BytecodeTraceElement {
    ...
    data class MethodCall(val owner: String, val name: String, val descriptor: String, val isStatic: Boolean) :
        BytecodeTraceElement()
}
