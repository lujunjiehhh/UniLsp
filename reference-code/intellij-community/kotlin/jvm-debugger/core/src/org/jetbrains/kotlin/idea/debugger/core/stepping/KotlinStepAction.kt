...
sealed class KotlinStepAction {
    ...
    class StepInto(private val filter: MethodFilter?) : KotlinStepAction() {
        override fun createCommand(
            ...
            return KotlinStepActionFactory.createStepIntoCommand(
                debugProcess,
                suspendContext,
                ignoreBreakpoints,
                filter,
    ...
    class KotlinStepOver(private val filter: KotlinMethodFilter, private val stepSize: Int = StepRequest.STEP_LINE) :
        KotlinStepAction() {
        override fun createCommand(
            debugProcess: DebugProcessImpl,
            suspendContext: SuspendContextImpl,
            ...
            return KotlinStepActionFactory.createKotlinStepOverCommand(
                debugProcess,
                suspendContext,
                ignoreBreakpoints,
                filter,
    ...
    class KotlinStepInto(private val filter: MethodFilter?) : KotlinStepAction() {
        override fun createCommand(
            ...
            return KotlinStepActionFactory.createKotlinStepIntoCommand(
                debugProcess,
                suspendContext,
                ignoreBreakpoints,
                filter
