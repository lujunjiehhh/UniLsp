        ...
        panel = panel {
            ...
            buttonsGroup {
                row(JavaDebuggerBundle.message("label.debugger.hotswap.configurable.reload.classes")) {
                    radioButton(
                        JavaDebuggerBundle.message("label.debugger.hotswap.configurable.always"),
                        DebuggerSettings.RUN_HOTSWAP_ALWAYS
                    )
                    radioButton(
                        JavaDebuggerBundle.message("label.debugger.hotswap.configurable.never"),
                        DebuggerSettings.RUN_HOTSWAP_NEVER
                    )
                    radioButton(
                        JavaDebuggerBundle.message("label.debugger.hotswap.configurable.ask"),
