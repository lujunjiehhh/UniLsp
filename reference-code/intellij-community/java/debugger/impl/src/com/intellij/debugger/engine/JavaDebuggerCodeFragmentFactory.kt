...
abstract class JavaDebuggerCodeFragmentFactory : CodeFragmentFactory() {
    final override fun createPsiCodeFragment(
    ...
    final override fun createPresentationPsiCodeFragment(
        item: TextWithImports,
        context: PsiElement?,
        project: Project
    ): JavaCodeFragment? {
    ...
    protected abstract fun createPresentationPsiCodeFragmentImpl(
        item: TextWithImports,
        context: PsiElement?,
        project: Project
    ): JavaCodeFragment?

    protected abstract fun createPsiCodeFragmentImpl(
        item: TextWithImports,
        context: PsiElement?,
        project: Project
    ): JavaCodeFragment?
