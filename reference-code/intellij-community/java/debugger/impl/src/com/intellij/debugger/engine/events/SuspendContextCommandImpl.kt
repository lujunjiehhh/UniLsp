 ...
 */
abstract class SuspendContextCommandImpl protected constructor(open val suspendContext: SuspendContextImpl?) :
    DebuggerCommandImpl() {
    ...
    private inline fun invokeWithChecks(operation: () -> Unit) {
        val suspendContext =
            suspendContext ?: error("SuspendContext is null, while is must be checked at the command start")
