...
abstract class SourcePositionProvider {
    ...
    protected open suspend fun computeSourcePositionAsync(
        ...
        ReadAction.nonBlocking<SourcePosition> { computeSourcePosition(descriptor, project, context, nearest) }
            .executeSynchronously()

    companion object {
        private val EP_NAME: ExtensionPointName<SourcePositionProvider> =
            ExtensionPointName.create("com.intellij.debugger.sourcePositionProvider")
