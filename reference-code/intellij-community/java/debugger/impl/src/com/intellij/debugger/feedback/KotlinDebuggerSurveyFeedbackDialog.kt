...
internal class KotlinDebuggerSurveyFeedbackDialog(
    project: Project?,
    forTest: Boolean
) : BlockBasedFeedbackDialog<KotlinDebuggerSystemData>(project, forTest) {
    ...
    override val myTitle: String =
        KotlinDebuggerFeedbackSurveyBundle.message("kotlin.debugger.feedback.dialog.top.title")
    ...
    override val myBlocks: List<FeedbackBlock> = mutableListOf<FeedbackBlock>().apply {
        add(
            TopLabelBlock(KotlinDebuggerFeedbackSurveyBundle.message("kotlin.debugger.feedback.dialog.title")).setBottomGap(
                BottomGap.MEDIUM
            )
        )
        add(
            SegmentedButtonBlock(
                KotlinDebuggerFeedbackSurveyBundle.message(
                    "kotlin.debugger.feedback.question.1.title",
                    fullApplicationName
                ),
        ...
        add(
            RadioButtonGroupBlock(
                KotlinDebuggerFeedbackSurveyBundle.message(
                    "kotlin.debugger.feedback.question.2.title",
                    fullApplicationName
                ),
                listOf(
                    RadioButtonItemData(
                    ...
                    RadioButtonItemData(
                        KotlinDebuggerFeedbackSurveyBundle.message(
                            "kotlin.debugger.feedback.question.2.option.4",
                            fullApplicationName
                        ),
