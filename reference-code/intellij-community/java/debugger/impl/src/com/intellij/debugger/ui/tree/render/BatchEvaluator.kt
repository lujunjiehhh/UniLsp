...
class BatchEvaluator private constructor() {
    ...
    private inner class BatchEvaluatorCommand(private val myEvaluationContext: EvaluationContext) : PossiblySyncCommand(
        ...
        override fun syncAction(suspendContext: SuspendContextImpl) {
            ...
            if ((commands.size == 1 && !`is`("debugger.batch.evaluation.force")) || !doEvaluateBatch(
                    commands,
                    myEvaluationContext
                )
            ) {
    ...
    companion object {
        ...
        private fun doEvaluateBatch(
            requests: MutableList<ToStringCommand>,
            ...
            try {
                ...
                if (exceptionFromTargetVM != null && "java.io.UTFDataFormatException" == exceptionFromTargetVM.referenceType()
                        .name()
                ) {
        ...
        private fun invokeDefaultHelperMethod(
            values: List<Value>,
            ...
            val objectArrayClass = evaluationContextImpl.debugProcess.findClass(
                ...
                "java.lang.Object[]",
                evaluationContextImpl.getClassLoader()
            ) as ArrayType
        ...
        private fun invokeHelperMethod(
                ...
                DebuggerUtils.getInstance().processCollectibleValue<String?, Value?>(
                    {
                        DebuggerUtilsImpl.invokeHelperMethod(
                            evaluationContextImpl,
                            BatchEvaluatorServer::class.java,
                            helperMethodName,
                            args,
                            false
                        )
