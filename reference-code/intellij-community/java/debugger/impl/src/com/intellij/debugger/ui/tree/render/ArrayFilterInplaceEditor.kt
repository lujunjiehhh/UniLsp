...
class ArrayFilterInplaceEditor(
    ...
    companion object {
                    ...
                    object : SuspendContextCommandImpl(javaValue.evaluationContext.suspendContext) {
                        ...
                        override fun contextAction(suspendContext: SuspendContextImpl) {
                            ...
                            if (value is ArrayReference) {
                                ...
                                val lastChildrenValue =
                                    ExpressionChildrenRenderer.getLastChildrenValue(javaValue.descriptor)
        ...
        fun editParent(parentNode: XValueNodeImpl, sessionProxy: XDebugSessionProxy) {
            ...
            if (node == null) {
                node = parentNode.addTemporaryEditorNode(
                    AllIcons.General.Filter,
                    JavaDebuggerBundle.message("message.node.filtered")
                )
                temp = true
            }
