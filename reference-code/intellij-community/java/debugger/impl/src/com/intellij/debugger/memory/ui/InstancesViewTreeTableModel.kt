...
class InstancesViewTreeTableModel(val tree: InstancesTree) : DefaultTreeModel(tree.root), TreeTableModel,
    ...
    override fun treeNodesChanged(e: TreeModelEvent) =
        fireTreeNodesChanged(e.source, e.path, e.childIndices, e.children)

    override fun treeNodesInserted(e: TreeModelEvent) =
        fireTreeNodesInserted(e.source, e.path, e.childIndices, e.children)

    override fun treeNodesRemoved(e: TreeModelEvent) =
        fireTreeNodesRemoved(e.source, e.path, e.childIndices, e.children)

    override fun treeStructureChanged(e: TreeModelEvent) =
        fireTreeStructureChanged(e.source, e.path, e.childIndices, e.children)
}
