...
interface EvaluationContextWrapper {
    fun wrapContext(
        project: Project,
        context: PsiElement?,
        additionalElements: List<AdditionalContextElement>
    ): PsiElement?
}
...
interface AdditionalContextProvider {
    ...
    companion object {
        private val EP_NAME =
            ExtensionPointName.create<AdditionalContextProvider>("com.intellij.debugger.additionalContextProvider")
 ...
 */
@ApiStatus.Internal
data class AdditionalContextElement(
    val name: String, val jvmSignature: String, val jvmTypeName: String,
...
internal class AdditionalContextIconProvider : IconProvider(), DumbAware {
    override fun getIcon(element: PsiElement, flags: Int): Icon? {
        val contextElement =
            element.getUserData(AdditionalContextProvider.ADDITIONAL_CONTEXT_ELEMENT_KEY) ?: return null
